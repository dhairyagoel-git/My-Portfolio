...
const ProjectCard: React.FC<props> = ({
  ...
  return (
    <div className='flex gap-4 flex-col  md:flex-row bg-[#27272a]/40 hover:brightness-110 p-3 md:p-4 rounded-lg text-neutral-400/70  font-noto text-base  md:text-base tracking-wide md:hover:scale-110 cursor-pointer ease-linear duration-100'>
